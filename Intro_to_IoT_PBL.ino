...
void alrmBuzz() { // Function for alarm 
    ...
    // if else-if and else statements which set a different alarm based on switch combination 

    if (switch1 == HIGH && switch3 == LOW && switch4 == LOW) 
    { 
        lcd.clear(); 
    ...
    else if (switch3 == HIGH && switch1 == LOW && switch4 == LOW) { 
        lcd.clear(); 
        ...
        else if (switch4 == HIGH && switch1 == LOW && switch3 == LOW) 
        { 
            lcd.clear(); 
            lcd.print("3 min alarm"); 
            delay(180000); 
    ...
    else if (switch1 == HIGH && switch3 == HIGH && switch4 == LOW) 
    { 
        lcd.clear(); 
        lcd.print("4 min alarm"); 
        delay(240000); 
    ...
    else if (switch1 == HIGH && switch4 == HIGH && switch3 == LOW) 
    { 
        lcd.clear(); 
        lcd.print("5 min alarm"); 
        delay(300000); 
    ...
    else if (switch1 == LOW && switch4 == HIGH && switch3 == HIGH) 
    { 
        lcd.clear(); 
        lcd.print("6 min alarm"); 
        delay(360000); 
...
void loop() { 
    ...
    lcd.clear(); 
    lcd.print("2,3: 2 min alarm"); 
    delay(1500); 

    lcd.clear(); 
    lcd.print("2,4: 3 min alarm"); 
    delay(1500); 

    lcd.clear(); 
    lcd.print("1,2,3: 4min alrm"); 
    delay(1500); 

    lcd.clear(); 
    lcd.print("1,2,4: 5min alrm"); 
    delay(1500); 

    lcd.clear(); 
    lcd.print("2,3,4: 6min alrm"); 
    delay(1500); 

    lcd.clear(); 
    lcd.print("2: 7 min alarm"); 
    delay(1500); 
